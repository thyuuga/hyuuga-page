...
const translations = {
  en: {
    ...
    "mio.showcase.mobile": "Mobile layout",
    "mio.showcase.mobileCaption": "Companion presence in hand",
  ...
  zh: {
    ...
    "mio.showcase.mobile": "移动端布局",
    "mio.showcase.mobileCaption": "掌心里的陪伴感",
  ...
  ja: {
    ...
    "mio.showcase.mobile": "モバイルレイアウト",
    "mio.showcase.mobileCaption": "手の中にある気配",
